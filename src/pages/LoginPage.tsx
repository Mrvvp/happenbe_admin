                        ...
                        {[
                            {
                                ...
                                label: 'Discover & list local events',
                                color: '#3b82f6'
                            },
                            {
                                ...
                                label: 'Verify organizers & approve claims',
                                color: '#58AEED'
                            },
                            {
                                icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>,
                                label: 'Track views, RSVPs and engagement',
                                color: '#10b981'
                            },
                            {
                                icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>,
                                label: 'Manage your admin team',
                                color: '#a78bfa'
                            },
                        ].map((f, i) => (
            ...
            <div style={{
                ...
                <div style={{ width: '100%', maxWidth: '360px' }}>
                    <div style={{ marginBottom: '36px' }}>
                        <h2 style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--text-primary)', margin: '0 0 8px', letterSpacing: '-0.03em' }}>
                            Sign in
                        </h2>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                        <div>
                            <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: '8px' }}>
                                Email
                            </label>
                            <input
                        ...
                        {error && (
                            <div style={{ padding: '11px 14px', borderRadius: '10px', background: 'rgba(220,38,38,0.07)', border: '1px solid rgba(220,38,38,0.2)', color: 'var(--error)', fontSize: '0.85rem', fontWeight: 600 }}>
                                {error}
                            </div>
                        )}
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: loading ? 'rgba(0,0,0,0.08)' : 'var(--accent-gradient)',
                    ...
                    <p style={{ fontSize: '0.78rem', color: 'var(--text-muted)', textAlign: 'center', marginTop: '28px' }}>
